	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="zhiwei" placeholder="职位" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">出生日期</label> 
							<input  name="chushengriqi" placeholder="出生日期" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="hetonghao" placeholder="合同号" class="form-control-i">
							</div>
