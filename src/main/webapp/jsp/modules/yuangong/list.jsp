...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="xueli" id="xueliSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('hetonghao')">合同号<i id="hetonghaoIcon" class="fa fa-sort"></i></th>
											<th>简历</th>
	...
	<script>
		...
		function search(){
			...
			var xueliIndex = document.getElementById("xueliSelect").selectedIndex;
			var xueliOptions = document.getElementById("xueliSelect").options;
			var xueliSelectedOption = xueliOptions[xueliIndex]
			if(xueliSelectedOption.text != null && xueliSelectedOption.text != ''){
				searchForm.xueli = xueliSelectedOption.text;
			}
			getDataList();
		}		
		// 获取数据列表
		...
		function setDataRow(item,number){
			...
			var hetonghaoCell  = document.createElement('td');

						 hetonghaoCell.innerHTML = item.hetonghao;

			row.appendChild(hetonghaoCell);
			var jianliCell  = document.createElement('td');

						  var jianliFile = document.createElement('button');
			  jianliFile.setAttribute('class','btn-table')
			  jianliFile.innerHTML = '下载';
			  var jianliFileAttr = "download('" +baseUrl+ item.jianli + "')"
