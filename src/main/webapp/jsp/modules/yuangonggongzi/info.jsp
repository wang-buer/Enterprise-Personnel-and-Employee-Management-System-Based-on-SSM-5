						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="kuanggong" name="kuanggong" class="form-control" v-model="ruleForm.kuanggong" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>个税</label>
									...
									<input id="gongjijin" name="gongjijin" class="form-control" v-model="ruleForm.gongjijin" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>社保代缴</label>
