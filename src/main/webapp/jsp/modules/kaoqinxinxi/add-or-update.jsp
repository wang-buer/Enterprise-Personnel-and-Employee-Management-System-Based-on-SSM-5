...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>应出勤天数</label>
										<input name="yingchuqintianshu" id="yingchuqintianshu" name="yingchuqintianshu" class="form-control" placeholder="应出勤天数">
									</div>
									<div class="form-group col-md-6">
										<label>出勤天数</label>
										<input name="chuqintianshu" id="chuqintianshu" name="chuqintianshu" class="form-control" placeholder="出勤天数">
									</div>
									<div class="form-group col-md-6">
										<label>请假时长</label>
									...
									<div class="form-group col-md-6">
										<label>加班时长</label>
										<input name="jiabanshizhang" id="jiabanshizhang" name="jiabanshizhang" class="form-control" placeholder="加班时长">
									</div>
									<div class="form-group col-md-6">
										<label>旷工时长</label>
										<input name="kuanggongshizhang" id="kuanggongshizhang" name="kuanggongshizhang" class="form-control" placeholder="旷工时长">
									</div>
									<div class="form-group col-md-6">
										<label>迟到次数</label>
										<input name="chidaocishu" id="chidaocishu" name="chidaocishu" class="form-control" placeholder="迟到次数">
									</div>
									<div class="form-group col-md-6">
										<label>早退次数</label>
										<input name="zaotuicishu" id="zaotuicishu" name="zaotuicishu" class="form-control" placeholder="早退次数">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#chuqintianshu").val(ruleForm.chuqintianshu);	
			$("#qingjiashizhang").val(ruleForm.qingjiashizhang);	
			$("#jiabanshizhang").val(ruleForm.jiabanshizhang);	
			$("#kuanggongshizhang").val(ruleForm.kuanggongshizhang);	
			$("#chidaocishu").val(ruleForm.chidaocishu);	
			$("#zaotuicishu").val(ruleForm.zaotuicishu);	
		}		
		//图片显示
		function showImg(){
		}		
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chuqintianshu != null && res.data.chuqintianshu != ''){

						$("#chuqintianshu").val(res.data.chuqintianshu);
						$("#chuqintianshu").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.jiabanshizhang != null && res.data.jiabanshizhang != ''){

						$("#jiabanshizhang").val(res.data.jiabanshizhang);
						$("#jiabanshizhang").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kuanggongshizhang != null && res.data.kuanggongshizhang != ''){

						$("#kuanggongshizhang").val(res.data.kuanggongshizhang);
						$("#kuanggongshizhang").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.zaotuicishu != null && res.data.zaotuicishu != ''){

						$("#zaotuicishu").val(res.data.zaotuicishu);
						$("#zaotuicishu").attr('readonly','readonly');
					}
				}
			});  
            }
