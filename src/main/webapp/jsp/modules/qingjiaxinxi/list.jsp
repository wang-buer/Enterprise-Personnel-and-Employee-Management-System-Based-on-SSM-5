...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('qingjialeixing')">请假类型<i id="qingjialeixingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qingjiashiyou')">请假事由<i id="qingjiashiyouIcon" class="fa fa-sort"></i></th>
											<th>材料证明</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var qingjialeixingCell  = document.createElement('td');

						 qingjialeixingCell.innerHTML = item.qingjialeixing;

			row.appendChild(qingjialeixingCell);
			var qingjiashiyouCell  = document.createElement('td');

						 qingjiashiyouCell.innerHTML = item.qingjiashiyou;

			row.appendChild(qingjiashiyouCell);
			var cailiaozhengmingCell  = document.createElement('td');

						  var cailiaozhengmingFile = document.createElement('button');
			  cailiaozhengmingFile.setAttribute('class','btn-table')
			  cailiaozhengmingFile.innerHTML = '下载';
			  var cailiaozhengmingFileAttr = "download('" +baseUrl+ item.cailiaozhengming + "')"
			  cailiaozhengmingFile.setAttribute('onclick',cailiaozhengmingFileAttr);
        	          cailiaozhengmingCell.appendChild(cailiaozhengmingFile);


			row.appendChild(cailiaozhengmingCell);
