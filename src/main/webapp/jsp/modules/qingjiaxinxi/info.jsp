...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="qingjialeixing" name="qingjialeixing" class="form-control" v-model="ruleForm.qingjialeixing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>请假事由</label>

									<input id="qingjiashiyou" name="qingjiashiyou" class="form-control" v-model="ruleForm.qingjiashiyou" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>材料证明</label>

									<button class="btn-upload" id="cailiaozhengming">点击下载</button>
									</div>
									<div class="form-group col-md-6">
									<label>开始时间</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var cailiaozhengmingUrl = "download('" + ruleForm.cailiaozhengming + "')";
			$("#cailiaozhengming").attr("onclick",cailiaozhengmingUrl);
		}			
		//设置音视频播放链接
